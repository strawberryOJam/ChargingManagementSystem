<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="电桩类别" prop="dianzhuangleibie">
          <el-input v-model="ruleForm.dianzhuangleibie" 
              placeholder="电桩类别" clearable  :readonly="ro.dianzhuangleibie"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="维修登记" prop="weixiudengji">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="维修登记"
                  v-model="ruleForm.weixiudengji" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.weixiudengji" label="维修登记" prop="weixiudengji">
                    <span>{{ruleForm.weixiudengji}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.weixiuzhuangtai = true;
          ...
          if(o=='weixiudengji'){
            this.ruleForm.weixiudengji = obj[o];
	    this.ro.weixiudengji = true;
            continue;
          }
        }
      }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `weixiuhuifu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.weixiuhuifuCrossAddOrUpdateFlag = false;
						 this.parent.search();
